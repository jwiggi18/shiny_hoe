...
my_desc$set("Package", "historyofearth")
...
# The urls
my_desc$set("URL", "https://github.com/ThinkR-open/historyofearth")
my_desc$set("BugReports", "https://github.com/ThinkR-open/historyofearth/issues")
# Save everyting
...
# Vignette
usethis::use_vignette("historyofearth")
